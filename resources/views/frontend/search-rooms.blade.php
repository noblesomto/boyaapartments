           ...
           <div class="row">
               ...
               <div class="col-md-5 col-sm-5">
                    ...
                    <div class="text-white">
                        <h3 class="text-white">
                            Available Apatments for Checkin and Checkout  on <br> <strong>{{ date('j F Y', strtotime($check_in)); }} - {{ date('j F Y', strtotime($check_out)); }}</strong>
                        </h3>
                    </div>
               </div>
           </div>
            ...
            <div class="col-lg-8 col-md-7 col-sm-12">
               <div class="room_details row-flex">
                  <div class="col-md-9 col-sm-9 col-xs-12 room_desc">
                     <h3><a href="/room/{{ $row->room_id }}/{{ $row->room_slug }}">{{ $row->apartment }} - {{Str::limit($row->room_title, 30, $end='...')}} </a></h3>
